...
public class OrderServiceImplTest {
    ...
    public void testCreate() {
        ...
        when(mockOrderRepository.findTopByOrderByIdDesc()).thenReturn(order1);
        ...
        when(mockOrderRepository.save(any(Order.class))).thenReturn(order2);
